...
public class GestorCrearAdm implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(objeto.equalsIgnoreCase("cliente")) {
			if (fc.getTxt2().getText().isEmpty() || fc.getTxt3().getText().isEmpty() || fc.getTxt5().getText().isEmpty()
			...
			if(fc.getTxt2().getText().isEmpty() || fc.getTxt3().getText().isEmpty()||fc.getTxt4().getText().isEmpty() 
			){
				fc.getErrores().setText("FALTAN CAMPOS OBLIGATORIOS [*]");	
			}else {
				tDTO = new TarjetaDTO();
